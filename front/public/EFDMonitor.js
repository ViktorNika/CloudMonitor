...
var Module = typeof loadWASMModule != 'undefined' ? loadWASMModule : {};
...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_getHelloMessage')) {
        Object.defineProperty(Module['ready'], '_getHelloMessage', { configurable: true, get: function() { abort('You are getting _getHelloMessage on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_getHelloMessage', { configurable: true, set: function() { abort('You are setting _getHelloMessage on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_getHelloMessage2')) {
        Object.defineProperty(Module['ready'], '_getHelloMessage2', { configurable: true, get: function() { abort('You are getting _getHelloMessage2 on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_getHelloMessage2', { configurable: true, set: function() { abort('You are setting _getHelloMessage2 on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
var wasmBinaryFile;
  wasmBinaryFile = 'EFDMonitor.wasm';
...
var ASM_CONSTS = {
  ...
  var GL = {debug:true,counter:1,buffers:[],programs:[],framebuffers:[],renderbuffers:[],textures:[],shaders:[],vaos:[],contexts:[],offscreenCanvases:{},queries:[],stringCache:{},unpackAlignment:4,recordError:function recordError(errorCode) {
        if (!GL.lastError) {
...
/** @type {function(...*):?} */
var _getHelloMessage = Module["_getHelloMessage"] = createExportWrapper("getHelloMessage");

/** @type {function(...*):?} */
var _main = Module["_main"] = createExportWrapper("main");

/** @type {function(...*):?} */
var _getHelloMessage2 = Module["_getHelloMessage2"] = createExportWrapper("getHelloMessage2");
...
if (typeof exports === 'object' && typeof module === 'object')
  ...
  define([], function() { return loadWASMModule; });
